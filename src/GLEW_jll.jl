...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import GLEW_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("bde7f898-03f7-559e-8810-194d950ce600"))
platforms = [Pkg.Artifacts.unpack_platform(e, "GLEW", artifacts_toml) for e in artifacts["GLEW"]]
...
if best_platform === nothing
    @debug("Unable to load GLEW; unsupported platform $(triplet(platform_key_abi()))")
else
